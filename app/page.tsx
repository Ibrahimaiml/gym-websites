...
import GymDashboards from '@/components/GymDashboards';
import LocationContact from '@/components/LocationContact';
import Footer from '@/components/Footer';
import { Star, Phone, Navigation, ShieldCheck, Dumbbell, Award, Flame, CheckCircle2, ArrowRight } from 'lucide-react';
...
export default function Home() {
  return (
    <div className="min-h-screen bg-dark-950 text-gray-100 flex flex-col selection:bg-beast-500 selection:text-black">
      ...
      <main className="flex-grow pt-24">
        ...
        <section className="relative min-h-[90vh] flex items-center justify-center py-12 md:py-20 overflow-hidden">
          ...
          <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-gradient-to-tr from-beast-500/15 via-beast-amber/10 to-transparent rounded-full filter blur-[120px] pointer-events-none"></div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                ...
                {/* Rating Badge */}
                <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-beast-500/10 border border-beast-500/30 shadow-glow-gold backdrop-blur-md">
                  <div className="flex text-beast-400">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 fill-beast-400" />
                    ))}
                  </div>
                ...
                <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black tracking-tight text-white leading-[1.08] font-heading">
                  ...
                  <span className="gold-gradient-text">Beauty and Beast</span> <br />
                  Fitness Gym
                </h1>
                ...
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 text-xs sm:text-sm font-semibold text-gray-300 pt-1">
                  <span className="px-3.5 py-1.5 rounded-xl bg-dark-900 border border-gray-800 flex items-center gap-1.5">
                ...
                <div className="pt-4 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                  <a
                    ...
                    className="w-full sm:w-auto inline-flex items-center justify-center space-x-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-beast-500 via-beast-600 to-beast-amber text-black font-black text-base md:text-lg shadow-glow-gold hover:scale-105 active:scale-95 transition-all"
                  >
        ...
        {/* --- STATS BAR BANNER --- */}
        <section className="py-8 bg-gradient-to-r from-beast-600/20 via-dark-900 to-beast-500/20 border-y border-beast-500/20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div>
                <span className="text-3xl md:text-4xl font-black text-white">5.0 ★</span>
              ...
              <div>
                ...
                <span className="text-xs text-emerald-400 font-semibold block mt-1">Real Transformation Guarantee</span>
              </div>
              <div>
                <span className="text-3xl md:text-4xl font-black text-white">Daily</span>
                <span className="text-xs text-beast-400 font-semibold block mt-1">Open 5:00 AM – 10:00 PM</span>
              </div>
              <div>
                <span className="text-3xl md:text-4xl font-black text-white">1-on-1</span>
                <span className="text-xs text-emerald-400 font-semibold block mt-1">Personal Certified Coaching</span>
              </div>
            </div>
          </div>
        </section>
