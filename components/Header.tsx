...
export default function Header() {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      scrolled 
        ? 'bg-dark-950/95 backdrop-blur-xl border-b border-beast-500/30 py-3 shadow-[0_4px_30px_rgba(0,0,0,0.9)]' 
        : 'bg-gradient-to-b from-dark-950/95 via-dark-950/50 to-transparent py-5'
    }`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <a href="#" className="flex items-center space-x-3 group">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-beast-500 to-beast-600 flex items-center justify-center shadow-glow-crimson group-hover:scale-105 transition-transform">
          ...
          <nav className="hidden lg:flex items-center space-x-8 text-sm font-semibold text-gray-300">
            ...
            <a href="#gallery" className="hover:text-beast-400 transition-colors">Beast Arena</a>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a
              ...
              className="inline-flex items-center space-x-2.5 px-5 py-2.5 rounded-full bg-gradient-to-r from-beast-500 to-beast-600 text-white font-extrabold text-sm shadow-glow-crimson hover:scale-105 active:scale-95 transition-all"
            >
          ...
          <button
            ...
            className="lg:hidden p-2 rounded-xl bg-dark-900 border border-neutral-800 text-gray-300 hover:text-white"
      ...
      {/* Mobile Menu Drawer */}
      {mobileMenuOpen && (
        <div className="lg:hidden bg-dark-950/98 backdrop-blur-2xl border-b border-beast-500/30 px-6 py-6 space-y-4 animate-in slide-in-from-top duration-300">
          <nav className="flex flex-col space-y-4 text-base font-bold text-gray-200">
            ...
            <a 
              href="#gallery" 
              onClick={() => setMobileMenuOpen(false)}
              className="hover:text-beast-400 transition-colors py-1 text-beast-400"
            >
              Beast Arena Gallery
            </a>
            <a 
          ...
          <div className="pt-4 border-t border-neutral-800">
            <a
              href="tel:08428090900"
              className="w-full inline-flex items-center justify-center space-x-2.5 px-6 py-3.5 rounded-2xl bg-gradient-to-r from-beast-500 to-beast-600 text-white font-black text-base shadow-glow-crimson"
            >
