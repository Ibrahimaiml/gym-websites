...
import { Calculator, Activity, CheckCircle, Phone, UserCheck } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight font-heading">
            AUTOMATED <span className="crimson-gradient-text">CALORIE & MACRO CALCULATOR</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Form Box (7 cols) */}
          <div className="lg:col-span-7 glass-panel rounded-3xl p-6 sm:p-8 border border-beast-500/30">
            <form onSubmit={handleCalculate} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className={`py-3 rounded-xl font-bold text-sm border transition-all ${
                      gender === 'male'
                        ? 'bg-beast-500 text-white border-beast-500 shadow-glow-crimson'
                        : 'bg-dark-800 text-gray-400 border-neutral-800 hover:border-beast-500/40'
                    }`}
                  >
                    Male 👨
                  </button>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-dark-950 border border-neutral-800 rounded-xl px-4 py-3 text-white text-sm font-semibold focus:outline-none focus:border-beast-500"
                    required
                  />
                </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    <button
                      ...
                      className={`py-2.5 px-2 rounded-xl text-xs font-bold border transition-all ${
                        dietPref === d.id
                          ? 'bg-beast-600 text-white border-beast-600 shadow-glow-crimson'
                          : 'bg-dark-800 text-gray-400 border-neutral-800 hover:border-beast-500/40'
                      }`}
                    >
                      {d.label}
              ...
              <button
                type="submit"
                className="w-full py-4 rounded-2xl bg-gradient-to-r from-beast-500 via-beast-600 to-beast-900 text-white font-black text-base uppercase tracking-wider shadow-glow-crimson hover:brightness-125 transition-all transform hover:-translate-y-0.5"
              >
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="glass-panel rounded-3xl p-6 sm:p-8 border border-beast-500/40 bg-gradient-to-b from-dark-900/95 to-dark-950/95 shadow-2xl">
              ...
              <div className="flex items-center space-x-3 mb-6 pb-4 border-b border-neutral-800">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white font-heading">Your Macro Plan Report</h3>
              ...
              {calculated ? (
                <div className="space-y-6 animate-in fade-in duration-300">
                  ...
                  <div className="p-4 rounded-2xl bg-beast-500/10 border border-beast-500/40 text-center shadow-glow-crimson">
                  ...
                  {/* Macro Cards Grid */}
                  <div className="grid grid-cols-3 gap-3">
                    <div className="p-3 rounded-xl bg-dark-950 border border-beast-500/40 text-center">
                      <span className="text-[11px] font-bold text-beast-400 block">PROTEIN</span>
                    ...
                    <div className="p-3 rounded-xl bg-dark-950 border border-neutral-700 text-center">
                      <span className="text-[11px] font-bold text-gray-300 block">CARBS</span>
                    ...
                    <div className="p-3 rounded-xl bg-dark-950 border border-neutral-700 text-center">
                      <span className="text-[11px] font-bold text-gray-300 block">FATS</span>
                  ...
                  <div className="p-4 rounded-xl bg-dark-950/90 border border-neutral-800 text-xs text-gray-300 space-y-2">
                    <div className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-beast-400 shrink-0" />
                      <span>Diet Plan: <strong className="text-white capitalize">{dietPref.replace('_', ' ')} Schedule</strong></span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-beast-400 shrink-0" />
                  ...
                  <a
                    ...
                    className="w-full inline-flex items-center justify-center space-x-2 py-3.5 rounded-xl bg-gradient-to-r from-beast-500 to-beast-600 text-white font-black text-sm uppercase tracking-wider shadow-glow-crimson hover:brightness-125"
                  >
                ...
                <div className="py-12 text-center space-y-4">
                  <div className="w-16 h-16 rounded-full bg-dark-800 text-beast-400 flex items-center justify-center mx-auto border border-neutral-700">
                    <UserCheck className="w-8 h-8" />
                  </div>
                  <h4 className="text-lg font-bold text-white font-heading">Fill Out Questionnaire</h4>
